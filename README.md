...
Click on the small `edit` button to configure `Time Periods` and `Work Place` for a specific day to override the defaults configured on the extension's Settings tab.
